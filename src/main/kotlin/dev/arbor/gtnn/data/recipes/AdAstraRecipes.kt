...
object AdAstraRecipes {
    ...
    fun remove(consumer: Consumer<ResourceLocation>) {
        fun ad(path: String): ResourceLocation = ResourceLocation.fromNamespaceAndPath("ad_astra", path)

        consumer.accept(ad("space_helmet"))
        consumer.accept(ad("space_suit"))
        consumer.accept(ad("space_pants"))
        consumer.accept(ad("space_boots"))
        consumer.accept(ad("netherite_space_helmet"))
        consumer.accept(ad("netherite_space_suit"))
        consumer.accept(ad("netherite_space_pants"))
        consumer.accept(ad("netherite_space_boots"))
        consumer.accept(ad("jet_suit_helmet"))
        consumer.accept(ad("jet_suit"))
        consumer.accept(ad("jet_suit_pants"))
        consumer.accept(ad("jet_suit_boots"))
        consumer.accept(ad("steel_engine"))
        consumer.accept(ad("rocket_nose_cone"))
        consumer.accept(ad("rocket_fin"))
        consumer.accept(ad("steel_tank"))
        consumer.accept(ad("nasa_workbench/tier_1_rocket_from_nasa_workbench"))
        consumer.accept(ad("nasa_workbench/tier_2_rocket_from_nasa_workbench"))
        consumer.accept(ad("nasa_workbench/tier_3_rocket_from_nasa_workbench"))
        consumer.accept(ad("nasa_workbench/tier_4_rocket_from_nasa_workbench"))
        consumer.accept(ad("desh_engine"))
        consumer.accept(ad("desh_tank"))
        consumer.accept(ad("ostrum_engine"))
        consumer.accept(ad("ostrum_tank"))
        consumer.accept(ad("calorite_engine"))
        consumer.accept(ad("calorite_tank"))
        consumer.accept(ad("oxygen_gear"))
        consumer.accept(ad("oxygen_tank"))
        consumer.accept(ad("fan"))
        consumer.accept(ad("gas_tank"))
        consumer.accept(ad("oxygen_loader"))
    }
}
